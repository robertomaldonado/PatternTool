...
echo "set output 'vector1CommonChars.eps';">> $filename

echo "set termoption dashed" >> $filename

echo "set style line 1 lt 1 lc 3 lw 3 " >> $filename #
echo "set style line 2 lt 2 lc 5 lw 3 " >> $filename #

echo "set style histogram errorbars gap 1 lw 1 lc 5" >> $filename
