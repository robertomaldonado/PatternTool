...
echo "set output '../syntactical/Totales2.eps';">> $filename
...
echo "set xtics('TNMQ' 1 , 'TNME' 2,  'TNE' 3, 'TNWAP' 4, 'TNK1' 5, 'TNK2' 6 , 'TNK3' 7 , 'TNCBS' 8 , 'TNCAS' 9 ) font \"FreeSans,16\"" >> $filename
